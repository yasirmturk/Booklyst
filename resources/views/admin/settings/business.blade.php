        ...
        <div class="col-12">
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-2">
                            <img class="img-thumbnail rounded w-100" style="object-fit: cover; height: 200px;" src="/images/s/{{ $business->images->first()['filename'] }}" />
                        </div>
                        <div class="col-6">
                            <h5>{{ $business->name }}
                        ...
                        <form action="{{ route('admin.settings.businesses.destroy', $business->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
